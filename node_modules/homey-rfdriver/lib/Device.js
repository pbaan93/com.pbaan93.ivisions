...
module.exports = superclass =>
	...
	class RFDevice extends superclass {
		...
		assembleSendData(sendData) {
			return Object.assign({}, this.getData(), this.lastFrame || {}, sendData);
		}
		...
		assembleDeviceObject() {
			...
			return Object.assign(
				{
					name: 'iVisions Projection Screen',
					data,
				},
				settings ? { settings } : {},
				store ? { store } : {},
		...
		send(data, options) {
			...
			return new Promise((resolve, reject) => {
				...
				if (!payload) {
					...
					reject(err);
					this.setUnavailable(Homey.__('433_generator.error.invalid_device'));
					return;
				}
